...
class NoteDetailViewModel @Inject constructor(
    ...
    fun onNoteTitleFocusChanged(hasFocus: Boolean) {
        savedStateHandle["isNoteTitleFocused"] = hasFocus
    }

    fun onNoteContentFocusChanged(hasFocus: Boolean) {
        savedStateHandle["isNoteContentFocused"] = hasFocus
    }
